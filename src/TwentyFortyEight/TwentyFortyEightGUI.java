        ...
        switch (val) {
            case 0:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/Background.PNG"));
                break;
            case 2:
            ...
            case 128:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/128.PNG"));
                break;
            case 256:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/256.PNG"));
                break;
            case 512:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/512.PNG"));
                break;
            case 1024:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/1024.PNG"));
                break;
            case 2048:
                this.image = new ImageIcon(
                        this.getClass().getClassLoader().getResource("src/resources/images/2048.PNG"));
                break;
            default:
